...
sagemaker_session <- function(){
  ...
  sms$.call_args("train", list(TrainingJobArn = "sagemaker-ntm-dummy"))
  sms$.call_args("create_model", "sagemaker-ntm")
  sms$.call_args("endpoint_from_production_variants", "sagemaker-ntm-endpoint")
